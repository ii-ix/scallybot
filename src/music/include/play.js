...
const { STAY_TIME } = require("../../../meta/config.json");
...
module.exports = {
  async play(song, message) {
    ...
    try {
      config = require("../../../meta/config.json");
    } catch (error) {
      config = null;
    }
    ...
    const musicQueueEnded = new Discord.MessageEmbed()
    ...
    if (!song) {
      ...
      queue.textChannel.send(musicQueueEnded).catch(console.error);
